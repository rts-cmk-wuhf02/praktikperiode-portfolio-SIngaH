document.addEventListener("DOMContentLoaded", ()=>{
    //-----------------------------gallery-------------------------------------
        ...
        let imgArray = ["assets/images/gallery/doctor_ce.jpg", "assets/images/gallery/doctor_dt.jpg", "assets/images/gallery/doctor_ms.jpg", "assets/images/gallery/doctor_pc.jpg", "assets/images/gallery/doctor_jw.jpg"];
    
        let nameArray = ["Christopher Eccleston", "David Tennant", "Matt Smith", "Peter Capaldi", "Jodie Whittaker"];
